...
def _load_migration_module():
    ...
    module_path = project_root / "alembic" / "versions" / "0095_drop_skip_uc_pending.py"
    spec = importlib.util.spec_from_file_location("v0095_drop_skip_uc_pending", module_path)
...
def test_drop_skip_uc_pending_upgrade_and_downgrade(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert upgraded["is_active"] in {False, 0}
