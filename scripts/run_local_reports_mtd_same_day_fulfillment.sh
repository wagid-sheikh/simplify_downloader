...
#   ./scripts/run_local_reports_mtd_same_day_fulfillment.sh --force --report-date 2026-03-31
#
...
echo "[run_local_reports_mtd_same_day_fulfillment] pipeline=mtd-same-day-fulfillment report_date=${report_date} regenerate=${regenerate}"
