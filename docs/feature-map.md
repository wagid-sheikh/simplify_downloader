...
- **CLI:** `poetry run python -m app crm rebuild-order-line-items --source td|uc|both --end-date YYYY-MM-DD [--start-date YYYY-MM-DD] [--window-size N] [--stores ...] [--dry-run] [--resume]`.
