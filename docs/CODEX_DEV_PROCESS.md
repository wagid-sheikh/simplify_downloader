...
This markdown file defines a strict, auditable workflow for Codex when developing or modifying the **app-based CRM backend** (formerly the `simplify_downloader` project) or any future project. Store it in the repo (e.g., `/docs/CODEX_DEV_PROCESS.md`) and reference it in each development prompt.
