...
- Daily Sales Short Payments PDF requires clean sales-backed proof: a sales row exists, payment proof exists, sales/evidence are consistent within ₹1, and that evidence is short against `vw_orders.order_amount` by more than ₹1.
