...
- `Actual Payments Not Found` remains date-window based by `vw_orders.order_date` for Daily/MTD report runs unless a separate approved change alters that contract.
