"""Add reporting mode suffix to TD leads run-summary subject."""
...
revision = "0098_td_leads_mode_suffix"
down_revision = "0097_payment_collections"
branch_labels = None
depends_on = None
...
NEW_SUBJECT_TEMPLATE = "{{ subject_prefix }}TD CRM Leads {{ run_id }}{{ reporting_mode_suffix }}"
OLD_SUBJECT_TEMPLATE = "{{ subject_prefix }}TD CRM Leads {{ run_id }}"
