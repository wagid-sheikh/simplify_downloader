"""Base missing-payments view on vw_orders."""
...
revision = "0105_missing_pay_vw_orders"
down_revision = "0104_create_vw_orders"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # Forward-only migration: keep the vw_orders-backed missing-payments view in place.
    pass
