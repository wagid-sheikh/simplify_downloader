"""Seed pipelines and notifications for daily sales report."""
...
revision = "0058_seed_daily_sales_report_notifications"
down_revision = "0057_create_cost_center_tables"
branch_labels = None
depends_on = None

PIPELINE_CODE = "reports.daily_sales_report"
PIPELINE_DESCRIPTION = "Reports Pipeline, Daily Sales Report"
...
TEMPLATE_SUBJECT = "{{ pipeline_name }}-{{ report_date }}"
TEMPLATE_BODY = """
{{ summary_text }}
{% if not summary_text %}
Daily Sales Report
...
def _upsert_profile(connection: sa.Connection, *, pipeline_id: int) -> int:
    ...
    stmt = (
        ...
        .values(
            ...
            code=PROFILE_CODE,
            description="Daily sales report notifications",
            env=PROFILE_ENV,
            scope=PROFILE_SCOPE,
