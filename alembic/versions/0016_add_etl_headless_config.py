"""Add ETL headless flag to system_config"""
...
def upgrade() -> None:
    ...
    _upsert_config(
        ...
        key="ETL_HEADLESS",
        value="false",
        description="Whether the single-session ETL browser runs in headless mode",
    )
...
def downgrade() -> None:
    ...
    bind.execute(system_config.delete().where(system_config.c.key == "ETL_HEADLESS"))
