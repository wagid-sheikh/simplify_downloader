"""Update orders sync templates with fact section rendering."""
...
def downgrade() -> None:
    ...
    _update_templates(
        connection,
        profile_ids=_fetch_profile_ids(connection, pipeline_code="td_orders_sync"),
        body_template=TD_OLD_BODY_TEMPLATE,
    )
    _update_templates(
        connection,
        profile_ids=_fetch_profile_ids(connection, pipeline_code="uc_orders_sync"),
        body_template=UC_OLD_BODY_TEMPLATE,
    )
    _update_templates(
        connection,
        profile_ids=_fetch_profiler_profile_ids(connection),
        body_template=PROFILER_OLD_BODY_TEMPLATE,
    )
