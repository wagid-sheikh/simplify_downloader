"""Update order notification templates for TD, UC, and profiler pipelines."""
...
revision = "0051_update_order_notification_templates"
down_revision = "0050_uc_orders_determinisfootr"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    _update_templates(connection, pipeline_code="td_orders_sync", body_template=TD_BODY_TEMPLATE)
    _update_templates(connection, pipeline_code="uc_orders_sync", body_template=UC_BODY_TEMPLATE)
    _update_templates(connection, pipeline_code="orders_sync_run_profiler", body_template=PROFILER_BODY_TEMPLATE)
