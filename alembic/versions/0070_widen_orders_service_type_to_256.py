"""Widen orders.service_type from 64 to 256 chars."""
...
revision = "0070_widen_orders_service_type_to_256"
down_revision = "0069_widen_ordersservicetypeto64"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("orders") as batch_op:
        batch_op.alter_column(
            "service_type",
            existing_type=sa.String(length=current_length or 256),
